...
class TranscriptReviewPage(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        speaker_grid.setVerticalSpacing(8)
        ...
        speaker_grid.addWidget(self.speaker_combo, 0, 0)
        ...
        speaker_grid.addWidget(self.save_speaker_button, 1, 1)
        for column in range(2):
            speaker_grid.setColumnStretch(column, 1)
        ...
        notes_fields = QVBoxLayout()
        notes_fields.setSpacing(9)
        ...
        notes_fields.addLayout(summary_column)
        decisions_column = QVBoxLayout()
        decisions_column.addWidget(_label("Decisions — one per line", "muted", wrap=True))
        ...
        notes_fields.addLayout(decisions_column)
        actions_column = QVBoxLayout()
        actions_column.addWidget(_label("Action items — one per line", "muted", wrap=True))
        ...
        notes_fields.addLayout(actions_column)
        ...
        segment_column.addWidget(self.segment_list)
        ...
        self.reset_assignment_button = QPushButton("Reset speaker")
        ...
        self.save_assignment_button = QPushButton("Save assignment")
        ...
        segment_column.addLayout(editor_column)
        transcript_layout.addLayout(segment_column)
