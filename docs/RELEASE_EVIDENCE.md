...
- Application commit: `9e3c5ce` (`codex/model-download-readiness`, PR
...
| Unit, integration, and UI behavior | 171 tests | Pass |
| Failure injection and synthetic one-hour audit | 29 selected tests from [`FAILURE_TEST_MATRIX.md`](FAILURE_TEST_MATRIX.md) | Pass |
| Windows CI on Python 3.12 and 3.13 | GitHub Actions PR run [31773281051](https://github.com/Dadaranger/Meeting-Transcriber/actions/runs/31773281051) and push run [31773278816](https://github.com/Dadaranger/Meeting-Transcriber/actions/runs/31773278816) | Pass |
...
| Installer compilation, archive, checksums, provenance, and artifact upload | GitHub Actions run [31773281073](https://github.com/Dadaranger/Meeting-Transcriber/actions/runs/31773281073) completed every required untagged step | Pass |
| Hosted artifact identity | `meeting-transcriber-windows-31773281073`, 224,100,865-byte upload containing the installer, portable ZIP, and checksum manifest | Pass |
...
| Desktop layout and reflow | Captured Home, History, Diagnostics, Recording Setup, Offline Transcription, and Transcript Review at the minimum desktop content size; geometry tests require readable wrapped text, vertical scrolling, no horizontal overflow, and visible setup actions | Pass; the exact installed hosted build also matched the accepted Home render |
...
Hosted PR #17 run `31773281073` artifact SHA-256 values:

- Portable ZIP: `27d97126a7cd6d6942ca0ddbf38504ac6e58a66d7083bf67315c1070462a4eea`
- Installer: `27770610dc37b67e8acad40aa1d36952066b86263c3af22548f375d8296b4abd`
